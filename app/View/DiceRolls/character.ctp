...
<?php if(!$isAjax): ?>
<?php $this->set('title_for_layout', $character['Character']['character_name'] . ' Game Interface'); ?>
    <h2><?php echo $character['Character']['character_name']; ?> Game Interface</h2>

<?php echo $this->Form->create('DiceRoll'); ?>
    <table class="undecorated-table">
        <tr>
            <td>
                <?php echo $this->Form->hidden('character_id', array('value' => $character['Character']['id'])); ?>
            ...
            <td>
                ...
                Current Fate: <span id="current-fate"><?php echo $character['Character']['current_fate']; ?></span>
            </td>
            <td rowspan="2">
    ...
    <script>
        ...
        $(function () {
            ...
            $("form").submit(function (e) {
                ...
                $.post(
                    '<?php echo $this->Html->url(array('action' => 'rollDiceCharacter')); ?>',
                    data,
                    function (response) {
                        roll.showRolls = false;
