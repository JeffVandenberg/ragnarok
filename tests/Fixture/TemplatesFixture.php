...
class TemplatesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'template_name' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'is_approved' => 1,
            'created_by_id' => 1,
            'created' => '2018-01-01 21:37:35',
            'updated_by_id' => 1,
            'updated' => '2018-01-01 21:37:35'
        ],
    ];
}
