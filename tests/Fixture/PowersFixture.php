...
class PowersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'power_name' => ['type' => 'string', 'length' => 45, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'power_name_UNIQUE' => ['type' => 'unique', 'columns' => ['power_name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'is_approved' => 1,
            'created_by_id' => 1,
            'created' => '2017-12-31 18:57:48',
            'updated_by_id' => 1,
            'updated' => '2017-12-31 18:57:48'
        ],
    ];
}
