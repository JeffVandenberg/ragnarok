...
<head>
    ...
    <meta name="viewport"
          content="width=device-width, target-densityDpi=device-dpi, initial-scale=1, user-scalable=no"/>
...
<div id="mainContainer" class="mainContainer">
    ...
    <div id="mainContainer">
        ...
        <div id="optionsContainer" class="optionsContainer">
            ...
            <textarea class="optionsBar" id="optionsBar" rows="10" cols="5"
                      onKeyPress="return submitenter(this,event,'optionsBar','chatContainer','');"
                      onfocus="changeMessBoxStyle('optionsBar');"></textarea>
		...
		<span class="optionsSelectStatus">
			...
			<span id="iconeCredits" class="iconeCredits" style="cursor:pointer;"
                  onclick='showInfoBox("ecredits","550","600","25","templates/default/ecredits.php","");'><?php echo C_LANG109; ?>
                : <span id="eCreditsID"></span></span>
		</span>
            ...
            <input class="optionsSend" id="optionsSend" type="button" value="<?php echo C_LANG136; ?>"
                   onclick="addMessage('optionsBar','chatContainer')">

            <?php if (!$_GET['sID']) { ?>
                <input class="optionsLogout" id="optionsLogout" type="button" value="<?php echo C_LANG137; ?>"
                       onclick="logout('0');">
            <?php } ?>
    ...
    <div id="rightContainer">
        <img id="roomIcon" class="roomIcon" src="images/rooms.gif" alt=""
             onclick="newRoom('<?php if ($_GET['sID']) { ?>0<?php }
             else { ?>1<?php } ?>');">

        <div id="roomCreate" class="roomCreate">
        <span><a href="http://wantonwicked.gamingsandbox.com/wiki/index.php?n=CityBook.CityBook#city" target="_new">Complete
                list of Districts</a><br>
        <br></span>
            <span><?php echo C_LANG129; ?> <span
                    title="Use () to designate a district location for the room, like (HD). Use [] if the room is located in another world, like [Hedge]."><img
                        src="http://wantonwicked.gamingsandbox.com/chat/images/menu/help_small.png"
            ...
            <span><?php echo C_LANG130; ?><input class="roomInput" type="text" id="roomPass" name="roomPass"
                                                 value=""></span>
            <br><br>
            <span><input class="roomButtons" type="button" name="roombutton" value="<?php echo C_LANG131; ?>"
                         onclick="addRoom();">&nbsp;<input class="roomButtons" type="button" name=""
                                                           value="<?php echo C_LANG132; ?>"
                                                           onclick="newRoom('0');"></span>
