...
$this->set('title_for_layout', __('Edit') . ': ' . $template->template_name);
?>
    ...
    <div id="tabs">
        ...
        <div id="powers">
            ...
            <table id="powers-table">
                ...
                <?php foreach ($template->template_powers as $row => $templatePower): ?>
                    <tr>
                        <td>
                            <?php echo $this->Form->control("template_powers.$row.id", array('class' => 'template-power-id')); ?>
                            <?php echo $this->Form->hidden("template_powers.$row.template_id"); ?>
                            <?php echo $this->Form->hidden("template_powers.$row.power_id", array('class' => 'power-id')); ?>
                            <?php echo $this->Form->control("template_powers.$row.power.power_name", array('label' => false, 'class' => 'power-name')); ?>
                        </td>
                        <td>
                            <?php echo $this->Form->control("template_powers.$row.power_cost", array('label' => false, 'class' => 'power-cost')); ?>
                        </td>
                        <td>
                            <div class="input">
            ...
            .on('click', '.delete-power', function () {
                ...
                if (templatePowerId === '') {
                    ...
                    if (confirm("Are you sure you want to remove " + powerName + "?")) {
                        var row = $(this);
                        var data = [];
                        data.push({name: 'template_power_id', value: templatePowerId});
                        $.post(
