...
<?php $this->start('javascript'); ?>
    <script type="text/javascript">
        ...
        function addSkillItem() {
            if(dfCharacter.nextRowNumber == null) {
                dfCharacter.nextRowNumber = $(".character-skill-item").length();
            }
            var newItem = $("<li></li>"),
                newContent = $("<div></div>").addClass('input'),
                rowId = dfCharacter.nextRowNumber++,
                skillName = $("<input />").addClass('skill_name').attr('name', 'character_skills[' + rowId + '][skill_name]').val('Skill Name').css('color', '#aaaaaa'),
                skillLevel = $("<input />").addClass('skill_level').attr('name', 'skill_level[]').val(0);
            newItem.append(
        ...
        $(function () {
            ...
            $("#sort-powers").click(function () {
                ...
                powers.sort(function (a, b) {
                    if (b.name == 'Power Name') {
                        return -1;
                    }
                    if (a.name == 'Power Name') {
                        return 1;
                    }
                    if (a.name < b.name) {
                        return -1;
            ...
            $("#sort-stunts").click(function () {
                ...
                stunts.sort(function (a, b) {
                    if (b.name == 'Stunt Name') {
                        return -1;
                    }
                    if (a.name == 'Stunt Name') {
                        return 1;
                    }
                    if (a.name < b.name) {
                        return -1;
