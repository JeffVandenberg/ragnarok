...
function userPanel(userName,targetUserName,targetUserId,roomId,userID,uAvatar,uBlock,uIP)
{
	...
	if(!document.getElementById("userpanel_"+targetUserId+roomId))
	{
        ...
        {
            // view sheet
            newdiv.innerHTML += "<div onmouseover=\"this.className='highliteOn'\" onmouseout=\"this.className='highliteOff'\" onclick=newWin('/characters/gmView/"+userID+"') class='highliteOff'><img style='vertical-align:middle;' src='images/usermenu/tool.gif'><span style='padding-left:10px;'>View Sheet</span></div>";
